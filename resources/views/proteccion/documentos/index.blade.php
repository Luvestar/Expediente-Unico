        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- BUSCADOR --}}
                    <form method="GET" action="{{ route('proteccion.documentos.index') }}" class="mb-4">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('proteccion.documentos.cargar', $c->id) }}" class="btn btn-sm btn-success" title="Cargar datos">
