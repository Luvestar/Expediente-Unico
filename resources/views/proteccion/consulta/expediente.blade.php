                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group btn-group-sm">
                                                                <a href="{{ route('proteccion.ver.pdf', ['path' => $ruta]) }}" target="_blank" class="btn btn-info" title="Ver PDF">
                                                                    <i class="fas fa-eye"></i> Ver
                                                                </a>
                                                                <a href="{{ route('proteccion.descargar.documento', ['path' => $ruta]) }}" class="btn btn-success" title="Descargar">
