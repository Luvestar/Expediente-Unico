                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($doc['estado'] == 'activo' && isset($doc['ruta']) && $doc['ruta'])
                                                <div class="btn-group">
                                                    <a href="{{ route('proteccion.ver.documento', ['path' => $doc['ruta']]) }}" target="_blank" class="btn btn-sm btn-info" title="Ver">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="{{ route('proteccion.descargar.documento', ['path' => $doc['ruta']]) }}" class="btn btn-sm btn-success" title="Descargar">
