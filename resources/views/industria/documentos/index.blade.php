        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- BUSCADOR --}}
                    <form method="GET" action="{{ route('industria.documentos.index') }}" class="mb-4">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                ...
                                @if(request('search'))
                                    <a href="{{ route('industria.documentos.index') }}" class="btn btn-secondary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <form action="{{ route('industria.contribuyente.eliminar', $c->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-danger" title="Eliminar" onclick="return confirm('¿Eliminar este contribuyente?')">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                            </form>
                                            <a href="{{ route('industria.documentos.cargar', $c->id) }}" class="btn btn-sm btn-success" title="Cargar datos">
