                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group btn-group-sm">
                                                                <a href="{{ route('industria.ver.pdf', ['path' => $ruta]) }}" target="_blank" class="btn btn-info" title="Ver PDF">
                                                                    <i class="fas fa-eye"></i> 
                                                                </a>
                                                                <a href="{{ route('industria.descargar.documento', ['path' => $ruta]) }}" class="btn btn-success" title="Descargar">
