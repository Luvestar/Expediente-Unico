                        ...
                        <tr>
                            ...
                            <td>
                                @if($doc['estado'] == 'activo' && isset($doc['ruta']) && $doc['ruta'])
                                    <div class="btn-group">
                                        <a href="{{ route('ingresos.ver.documento', ['path' => $doc['ruta']]) }}" target="_blank" class="btn btn-sm btn-info" title="Ver">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('ingresos.descargar.documento', ['path' => $doc['ruta']]) }}" class="btn btn-sm btn-success" title="Descargar">
