    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('ingresos.documentos.index') }}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Ingresos</span>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        <li class="nav-item">
                            <a href="{{ route('ingresos.documentos.index') }}" class="nav-link">
                                <i class="nav-icon fas fa-upload"></i>
                                <p>Agregar datos</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('ingresos.consultar') }}" class="nav-link">
                                <i class="nav-icon fas fa-search"></i>
                                <p>Consultar información</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('ingresos.historial') }}" class="nav-link">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ route('ingresos.documentos.index') }}">Ingresos</a></li>
        ...
        <footer class="main-footer">
            <strong>Ingresos - Tepeaca</strong>
        </footer>
    </div>
