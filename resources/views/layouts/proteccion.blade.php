...
<head>
    ...
    <title>Protección Civil - Tepeaca</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    @php
        $currentGuard = session('current_guard', 'proteccion');
    ...
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">
                        ...
                        <small class="text-muted d-block">
                            {{ $user->area->nombre ?? 'Protección Civil' }}
                        </small>
                    </a>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="{{ route('proteccion.documentos.index') }}" class="brand-link">
                <div class="brand-image img-circle elevation-3 d-flex align-items-center justify-content-center" style="width: 35px; height: 35px; background-color: #ffffff;">
                    <i class="fas fa-shield-alt" style="color: #7B1B58; font-size: 18px;"></i>
                </div>
                <span class="brand-text font-weight-light">Protección Civil</span>
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        ...
                        <div class="text-muted small mt-1">
                            <i class="fas fa-building"></i> {{ $user->area->nombre ?? 'Protección Civil' }}
                        </div>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        <li class="nav-item">
                            <a href="{{ route('proteccion.documentos.index') }}" class="nav-link">
                                <i class="nav-icon fas fa-upload"></i>
                                <p>Agregar datos</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('proteccion.consultar') }}" class="nav-link">
                                <i class="nav-icon fas fa-search"></i>
                                <p>Consultar información</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('proteccion.historial') }}" class="nav-link">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ route('proteccion.documentos.index') }}">Protección Civil</a></li>
        ...
        <footer class="main-footer">
            <strong>Protección Civil - Tepeaca</strong>
            <div class="float-right d-none d-sm-block">
                <b>HACER EQUIPO - SERVIR A TEPEACA</b>
            </div>
        </footer>
    </div>
