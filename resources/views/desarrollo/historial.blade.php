        ...
        <div class="col-12">
            ...
            <div class="sticky-header">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('desarrollo.historial.exportar.csv') }}" method="GET" class="row g-3">
                            <div class="col-md-3">
            ...
            <div class="card-header bg-success text-white mt-4">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('desarrollo.historial') }}" class="btn btn-sm btn-light {{ !request('estado') ? 'active' : '' }}">Todos</a>
                        <a href="{{ route('desarrollo.historial', ['estado' => 'vigente']) }}" class="btn btn-sm btn-light {{ request('estado') == 'vigente' ? 'active' : '' }}">Vigentes</a>
                        <a href="{{ route('desarrollo.historial', ['estado' => 'proximo']) }}" class="btn btn-sm btn-light {{ request('estado') == 'proximo' ? 'active' : '' }}">Próximos</a>
                        <a href="{{ route('desarrollo.historial', ['estado' => 'vencido']) }}" class="btn btn-sm btn-light {{ request('estado') == 'vencido' ? 'active' : '' }}">Vencidos</a>
                    </div>
                </div>
            </div>
                                            ...
                                            <tr class="border-bottom">
                                                ...
                                                <td width="20%">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="{{ route('desarrollo.documento.detalle', $doc->id) }}" class="btn btn-outline-info"><i class="fas fa-eye"></i> Detalle</a>
                                                        @if($doc->estado == 'vencido')
                                                            ...
                                                            <form action="{{ route('desarrollo.documento.eliminar', $doc->id) }}" method="POST" class="d-inline">
                                                                @csrf @method('DELETE')
                        ...
                        <div class="modal fade" id="renovarModal{{ $doc->id }}" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ route('desarrollo.documento.actualizar', $doc->id) }}" method="POST">
                                        @csrf @method('PUT')
