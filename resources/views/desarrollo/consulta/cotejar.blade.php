                                    ...
                                    <tr>
                                        @if($doc['area'] != $areaAnterior)
                                            <td rowspan="{{ $areaCounts[$doc['area']] }}">
                                                ...
                                                @if(isset($doc['subido_por']) && $doc['subido_por'])
                                        ...
                                        <td>
                                            @if($doc['estado'] == 'activo' && isset($doc['ruta']) && $doc['ruta'])
                                                <div class="btn-group">
                                                    <a href="{{ route('desarrollo.ver.documento', ['path' => $doc['ruta']]) }}" target="_blank" class="btn btn-sm btn-info" title="Ver">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="{{ route('desarrollo.descargar.documento', ['path' => $doc['ruta']]) }}" class="btn btn-sm btn-success" title="Descargar">
