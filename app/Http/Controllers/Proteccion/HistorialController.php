...
namespace App\Http\Controllers\Proteccion;
...
class HistorialController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('proteccion.historial', compact(
            'actividades', 
            'vigentes', 
            'vencidos',
            'proximos',
    ...
    public function verTramite($id)
    {
        ...
        return view('proteccion.historial.ver', compact('actividad'));
    }
    
    public function verDetalle($id)
    {
        $documento = DocumentoVigencia::with('contribuyente')->findOrFail($id);
        return view('proteccion.detalle_documento', compact('documento'));
    }
    ...
    public function actualizarVigencia(Request $request, $id)
    {
        ...
        return redirect()->route('proteccion.historial')
    ...
    public function exportarCSV(Request $request)
{
    ...
    $nombreArchivo = 'historial_proteccion_' . $fechaInicio . '_al_' . $fechaFin . '.csv';
