...
class ConsultaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('proteccion.consulta.index', compact('resultados'));
    }
    ...
    public function expediente($id)
    {
        ...
        return view('proteccion.consulta.expediente', compact('contribuyente', 'tramites'));
    }
    ...
    public function cotejar($id)
    {
        ...
        return view('proteccion.consulta.cotejar', compact('contribuyente', 'documentos'));
    }
