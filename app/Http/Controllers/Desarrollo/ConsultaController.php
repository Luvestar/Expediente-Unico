...
class ConsultaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('desarrollo.consulta.index', compact('resultados'));
    }
    ...
    public function expediente($id)
    {
        ...
        return view('desarrollo.consulta.expediente', compact('contribuyente', 'tramites'));
    }
    ...
    public function cotejar($id)
    {
        ...
        return view('desarrollo.consulta.cotejar', compact('contribuyente', 'documentos'));
    }
